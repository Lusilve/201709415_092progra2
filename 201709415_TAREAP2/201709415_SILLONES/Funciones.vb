Module Funciones
    ...
    Public numero(8) As Byte
    Public numero_referencia(8) As Double
    ...
    Sub mensajes()
        If IsNumeric(Form1.txtreferencia.Text) = False Then

            MsgBox("ingrese datos validos",, "Numero de referencia de venta")
    ...
    Function costo1(pmano As Double, cyarda As Double, tmaterial As Double)
        Dim pcosto(8) As Double

        pcosto(indice) = (pmano + (cyarda * tmaterial))
